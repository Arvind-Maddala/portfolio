...
const About = () => {
  ...
  return (
    <motion.ul className="about" variants={container} initial="hidden" animate="visible">
      ...
      <h3 >About </h3>
      <p>I'm <span className="about__aravind">Aravind</span>, an Innovative and enthusiastic developer. After discovering my passion for software development and everything in its orbit, I recently began to be fascinated by web programming, e.g. developing apps and building websites. I would describe myself as a competent front-end developer who has a passion for design. </p>
      </motion.li>
